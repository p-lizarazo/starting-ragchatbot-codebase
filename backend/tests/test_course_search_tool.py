...
class TestCourseSearchTool:
    ...
    def test_execute_with_empty_search_results(self, mock_vector_store, empty_search_results):
...
class TestCourseSearchToolWithBuggyVectorStore:
    ...
    def test_tool_with_zero_max_results_vector_store(self, test_config):
        ...
        print("This explains why users see 'query failed' or 'no content found' messages!")
...
class TestToolManager:
    ...
    def test_tool_execution_through_manager(self, mock_vector_store, sample_search_results):
