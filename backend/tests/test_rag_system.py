...
class TestRAGSystemQueryProcessing:
    ...
    def test_query_processing_with_successful_tool_usage(
        self, test_config, sample_search_results
    ):
    ...
    def test_query_processing_with_empty_search_results(self, test_config):
        ...
        with (
            ...
            )  # Tool should return this message
    ...
    def test_query_exception_propagation(self, test_config):
        ...
        with (
            ...
            print(
                "Exceptions propagate to the API layer, causing 'query failed' responses"
            )
...
class TestRAGSystemWithRealComponents:
    ...
    def test_end_to_end_query_processing_success(
        self,
    ...
    @patch("rag_system.AIGenerator")
    @patch("rag_system.VectorStore")
    def test_end_to_end_query_processing_with_buggy_vector_store(
        self, mock_vector_store_class, mock_ai_generator_class, test_config
    ):
