...
class TestConfig:
    ...
    def test_max_results_configuration_issue(self):
        ...
        ), f"MAX_RESULTS is {test_config.MAX_RESULTS}, should be positive"
        assert (
            test_config.MAX_RESULTS == 5
        ), f"MAX_RESULTS is {test_config.MAX_RESULTS}, expected 5"
    ...
    def test_environment_variable_loading(self):
        ...
        assert (
            len(test_config.ANTHROPIC_API_KEY) > 0
    ...
    def test_configuration_values_reasonable(self):
        ...
        assert (
            test_config.MAX_RESULTS > 0
        ), "MAX_RESULTS should be positive for search to work!"
